...
public class Afgewerktproduct implements Old { 
...
private double eenheden_etiket;
...
public Afgewerktproduct(String[] data){
...
this.id_receptgroep = Util.Int(data[7]);
this.bereidingswijze = data[8];
this.inserted = Util.Date(data[9]);
this.updated = Util.Date(data[10]);
this.cc = Util.Int(data[11]);
this.id_recepteenheid = Util.Int(data[12]);
this.id_receptingave = Util.Int(data[13]);
this.voorraad = Util.Boolean(data[14]);
this.voorraad_minimum = Util.Double(data[15]);
this.voorraad_maximum = Util.Double(data[16]);
this.eenheden_etiket = Util.Double(data[17]);
...
this.id_bewaartemperatuur = Util.Int(data[25]);
this.id_voedingswaarden_bron = Util.Int(data[26]);
this.id_vaste_kost = Util.Int(data[27]);
this.id_onrechtstreekse_produktiekost = Util.Int(data[28]);
this.produktie_hoeveelheid = Util.Double(data[29]);
this.blokkeren = Util.Boolean(data[30]);
this.blokkeren_einddatum = Util.Date(data[31]);
this.code_houdbaarheid = Util.Int(data[32]);
this.aantal_personen = data[33];
this.aantal_personen_variabel = Util.Boolean(data[34]);
this.eenheidsgewicht = Util.Double(data[35]);
this.berekenen_voedingswaarden = Util.Boolean(data[36]);
this.id_bewaarconditie = Util.Int(data[37]);
this.recept_percentage_bakverlies = Util.Double(data[38]);
this.id_deelbaar = Util.Int(data[39]);
this.recept_wijzigbaar = Util.Boolean(data[40]);
this.vaste_kost_per_eenheid = Util.Double(data[41]);
this.volgorde = Util.Int(data[42]);
this.moet_gewogen_worden = Util.Boolean(data[43]);
this.maximaal_meetgewicht = Util.Double(data[44]);
this.relatieve_marge = Util.Double(data[45]);
this.absolute_marge = Util.Double(data[46]);
this.lijn_na_produktielijst = Util.Boolean(data[47]);
this.arcering_op_produktielijst = Util.Boolean(data[48]);
this.omschrijving_voorraadplaats = data[49];
this.voorraad_maandag = Util.Boolean(data[50]);
this.voorraad_dinsdag = Util.Boolean(data[51]);
this.voorraad_woensdag = Util.Boolean(data[52]);
this.voorraad_donderdag = Util.Boolean(data[53]);
this.voorraad_vrijdag = Util.Boolean(data[54]);
this.voorraad_zaterdag = Util.Boolean(data[55]);
this.voorraad_zondag = Util.Boolean(data[56]);
this.dagproduktie = Util.Boolean(data[57]);
this.id_job = Util.Int(data[58]);
this.job_volgnummer = Util.Int(data[59]);
this.omschrijvinge = data[60];
this.excel_produktie_blad = Util.Int(data[61]);
this.excel_produktie_kolom = data[62];
this.excel_produktie_rij = Util.Int(data[63]);
this.id_verkoopsverpakking = Util.Int(data[64]);
}
...
public double getEenheden_etiket() {
...
public double getProduktie_hoeveelheid() {
return this.produktie_hoeveelheid;
}
...
public int getCode_houdbaarheid() {
return this.code_houdbaarheid;
}
...
public boolean getBerekenen_voedingswaarden() {
return this.berekenen_voedingswaarden;
}
...
public void setEenheden_etiket(double eenheden_etiket){
...
public void setProduktie_hoeveelheid(double produktie_hoeveelheid){
 this.produktie_hoeveelheid=produktie_hoeveelheid;
 }
...
public void setCode_houdbaarheid(int code_houdbaarheid){
 this.code_houdbaarheid=code_houdbaarheid;
 }
...
public void setBerekenen_voedingswaarden(boolean berekenen_voedingswaarden){
 this.berekenen_voedingswaarden=berekenen_voedingswaarden;
 }
