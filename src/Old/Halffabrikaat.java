...
public class Halffabrikaat implements Old { 
private int id_bedrijf;
private int id_halffabrikaat;
...
public Halffabrikaat(String[] data){
this.id_bedrijf = Util.Int(data[0]);
this.id_halffabrikaat = Util.Int(data[1]);
...
this.id_kneder = Util.Int(data[7]);
...
this.id_receptgroep = Util.Int(data[14]);
this.voorraad = Util.Boolean(data[15]);
this.voorraad_minimum = Util.Double(data[16]);
this.voorraad_maximum = Util.Double(data[17]);
this.eenheden_etiket = Util.Int(data[18]);
this.minimum_aantal_dagen_houdbaar = Util.Int(data[19]);
this.recept_aantal_stuks = Util.Int(data[20]);
this.recept_aantal_personen = Util.Int(data[21]);
this.bestandsnaam_foto = data[22];
this.id_etiket = Util.Int(data[23]);
this.id_voorraadplaats = Util.Int(data[24]);
this.etiket = Util.Boolean(data[25]);
this.id_vaste_kost = Util.Int(data[26]);
this.id_onrechtstreekse_produktiekost = Util.Int(data[27]);
this.blokkeren = Util.Boolean(data[28]);
this.blokkeren_einddatum = Util.Date(data[29]);
this.id_bewaarconditie = Util.Int(data[30]);
this.recept_percentage_bakverlies = Util.Double(data[31]);
this.id_bewaartemperatuur = Util.Int(data[32]);
this.id_deelbaar = Util.Int(data[33]);
this.recept_wijzigbaar = Util.Boolean(data[34]);
this.vaste_kost_per_eenheid = Util.Double(data[35]);
this.volgorde = Util.Int(data[36]);
this.moet_gewogen_worden = Util.Boolean(data[37]);
this.maximaal_meetgewicht = Util.Double(data[38]);
this.relatieve_marge = Util.Double(data[39]);
this.absolute_marge = Util.Double(data[40]);
this.lijn_na_produktielijst = Util.Boolean(data[41]);
this.arcering_op_produktielijst = Util.Boolean(data[42]);
this.omschrijving_voorraadplaats = data[43];
this.voorraad_maandag = Util.Boolean(data[44]);
this.voorraad_dinsdag = Util.Boolean(data[45]);
this.voorraad_woensdag = Util.Boolean(data[46]);
this.voorraad_donderdag = Util.Boolean(data[47]);
this.voorraad_vrijdag = Util.Boolean(data[48]);
this.voorraad_zaterdag = Util.Boolean(data[49]);
this.voorraad_zondag = Util.Boolean(data[50]);
this.dagproduktie = Util.Boolean(data[51]);
this.id_job = Util.Int(data[52]);
this.job_volgnummer = Util.Int(data[53]);
this.omschrijvinge = data[54];
this.excel_produktie_blad = Util.Int(data[55]);
this.excel_produktie_kolom = data[56];
this.excel_produktie_rij = Util.Int(data[57]);
this.id_verkoopsverpakking = Util.Int(data[58]);
}
public int getId_bedrijf() {
return this.id_bedrijf;
}
public int getId_halffabrikaat() {
return this.id_halffabrikaat;
}
...
public void setId_halffabrikaat(int id_halffabrikaat){
 this.id_halffabrikaat=id_halffabrikaat;
 }
